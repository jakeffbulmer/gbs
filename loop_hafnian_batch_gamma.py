...
####################### compile on some small instances ################
A = np.ones((4,4))
D = np.ones((10,4))

batch = loop_hafnian_batch_gamma(A, D, [1,1,2], 4)
assert np.allclose(batch, np.array([[ 10,  26,  76, 232, 764],
                           [ 10,  26,  76, 232, 764],
                           [ 10,  26,  76, 232, 764],
                           [ 10,  26,  76, 232, 764],
                           [ 10,  26,  76, 232, 764],
                           ...
                           [ 10,  26,  76, 232, 764],
                           [ 10,  26,  76, 232, 764]]))
batch = loop_hafnian_batch_gamma(A, D, [1,1,1], 5)
assert np.allclose(batch, np.array([[4, 10,  26,  76, 232, 764],
                           [4, 10,  26,  76, 232, 764],
                           [4, 10,  26,  76, 232, 764],
                           [4, 10,  26,  76, 232, 764],
                           [4, 10,  26,  76, 232, 764],
